# Generated by Django 5.0.6 on 2024-05-26 19:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('messege', models.TextField(max_length=1500)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address_province', models.CharField(blank=True, default='', max_length=30, null=True)),
                ('address_location', models.CharField(blank=True, default='', max_length=30, null=True)),
                ('address_street', models.CharField(blank=True, default='', max_length=50, null=True)),
                ('address_number', models.IntegerField(blank=True, default=0, null=True)),
